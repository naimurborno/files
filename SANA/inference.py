...
Model is selected via config.yaml:
    model_name: "flux"          # flux | sd | sd3 | sd3_onlb | sd3_peakback | sd3_ugile |
                                 # sana | sana_ugile | lumina | janus | cogvideo | mini_gemini

Multi-seed (sd3_onlb, sd3_peakback, sd3_ugile, sana_ugile only):
    ...
    (sd3_peakback / sd3_ugile / sana_ugile, see the matching config block).
...
def main():
    ...
    if model_name in ("sd3_onlb", "sd3_peakback", "sd3_ugile", "sana_ugile"):
        seeds = opts["seeds"]
